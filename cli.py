"""
Provides a command line interface for the Daily Intel Briefing research engine.
...
from gpt_researcher import GPTResearcher as DailyIntelResearcher
...
async def main(args):
    ...
    if args.report_type == 'detailed_report':
        ...
        researcher = DailyIntelResearcher(
            query=args.query,
            query_domains=query_domains,
