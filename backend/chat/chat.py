...
# Note: LLM client is handled through the internal research engine's unified LLM system.
...
class ChatAgentWithMemory:
    ...
    async def chat(self, messages, websocket=None):
        ...
        try:
            ...
            system_prompt = f"""
            You are 每日情报速递, a public company, product, and industry intelligence assistant.
            You help users understand generated intelligence reports, explain source-backed findings, and highlight uncertainties.
